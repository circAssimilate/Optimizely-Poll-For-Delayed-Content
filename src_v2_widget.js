...

 {
  ...
  "form_schema": [
    ...
    },
    {
      "default": "",
      "field_type": "number",
      "label": "Unhide Delay In Milliseconds",
      "options": null,
  ...
  "description": "This Widget uses CSS stylesheets to hide elements before they are added to the page and a DOM Mutation Observer or recursive timeout to detect, change and unhide elements after they are added.",
  "options": {
